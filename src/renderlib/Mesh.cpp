...
void Mesh::upload_mesh(SDL_GPUCopyPass *copy_pass, SDL_GPUDevice *device) const {
...
void Mesh::draw(SDL_GPURenderPass *render_pass, SDL_GPUSampler *sampler, const Camera *camera, SDL_GPUCommandBuffer *command_buffer, const std::vector<PointLight *> &lights, glm::mat4 model_mat) const {
